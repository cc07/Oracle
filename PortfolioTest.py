...
class PortfolioTest(unittest.TestCase):
    ...
    def test_reward(self):
        ...
        reward = self.portfolio.get_reward([1.2995, 1.3011], 2, 0)
        self.assertAlmostEqual(reward, -1, 7,
            'Incorrect reward: {}, Expected: 0'.format(reward))

        reward = self.portfolio.get_reward([1.2995, 1.3011], 2, 0)
        self.assertAlmostEqual(reward, -0.20710678, 7,
            'Incorrect reward: {}, Expected: -0.20710678'.format(reward))
